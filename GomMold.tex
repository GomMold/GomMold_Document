...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.35\columnwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Identify Page - Success Result (1).png}
        \caption{Mold detected}
        \label{fig:mold-detected}
    \end{minipage}%
    \begin{minipage}{0.35\columnwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Identify Page - Failed Result (1).png}
...
\noindent The Identify Page runs the AI model to analyze mold images and display results directly on-screen.
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item Flask backend sends the image to the YOLO model (implemented using PyTorch).
            \item The model detects whether it is mold
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.35\columnwidth]{Images/ChatBot (1).png}
